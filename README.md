...
> 下面是 GitHub 首页用的功能布局示意图，不是实际软件截图。真实界面以本地客户端为准。

![LoL BP Coach 功能示意图](docs/images/ui-preview.svg)
...
- Release 文案：[`docs/release_notes_v0.2.0.md`](docs/release_notes_v0.2.0.md)
- 朋友测试说明：[`docs/friend_test_guide.md`](docs/friend_test_guide.md)
